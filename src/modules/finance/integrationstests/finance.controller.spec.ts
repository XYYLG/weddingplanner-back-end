...
describe("FinanceController (Mock)", () => {
    ...
    it("Moet een nieuw bedrag aanmaken via API", async () => {
        ...
        expect(body).toEqual(expect.objectContaining({ ...newFinanceDto, id: "3", updatedAt: expect.any(String) }));
    });
    ...
    it("Moet een bestaande bedrag updaten via API", async () => {
        ...
        expect(status).toBe(200);
        expect(body).toEqual(expect.objectContaining({ ...updatedFinanceDto, id: "1", updatedAt: expect.any(String) }));
    });
